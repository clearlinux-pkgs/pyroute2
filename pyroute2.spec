...
Version  : 0.5.14
Release  : 38
URL      : https://files.pythonhosted.org/packages/0b/71/2920f854ef3cbb8472aa70539cf63fcc214e5c1b40f21c7cdb4910a6f5e9/pyroute2-0.5.14.tar.gz
...
%prep
%setup -q -n pyroute2-0.5.14
cd %{_builddir}/pyroute2-0.5.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599763970
...
cp %{_builddir}/pyroute2-0.5.14/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pyroute2/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2-0.5.14/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pyroute2/4cc77b90af91e615a64ae04893fdffa7939db84c
