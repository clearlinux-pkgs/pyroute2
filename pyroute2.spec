...
Version  : 0.6.3
Release  : 55
URL      : https://files.pythonhosted.org/packages/fc/83/0f23f35d86ed8a9587b1567facdee13577a148608c4bb736abc819916abc/pyroute2-0.6.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/fc/83/0f23f35d86ed8a9587b1567facdee13577a148608c4bb736abc819916abc/pyroute2-0.6.3.tar.gz
...
%prep
%setup -q -n pyroute2-0.6.3
cd %{_builddir}/pyroute2-0.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622567814
...
cp %{_builddir}/pyroute2-0.6.3/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pyroute2/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2-0.6.3/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pyroute2/4cc77b90af91e615a64ae04893fdffa7939db84c
