...
%prep
%setup -q -n pyroute2-0.5.19
cd %{_builddir}/pyroute2-0.5.19
...
cp %{_builddir}/pyroute2-0.5.19/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pyroute2/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2-0.5.19/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pyroute2/4cc77b90af91e615a64ae04893fdffa7939db84c
